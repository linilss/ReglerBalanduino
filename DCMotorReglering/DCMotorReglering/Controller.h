...
//static const double EncoderRes = 928.0;
static const double EncoderRes = 928.0*2.0; // Mod Jonas
...
static void c2d(PID_cont_t pid_c, PID_discrete_t pid_d, double h);
static inline double PID_discrete(double setpoint_value, double actual_value, PID_discrete_t *pid_discrete);
